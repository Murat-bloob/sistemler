...
exports.run = async (client, message, args) => {
  ...
  .setDescription(`**•** \`${prefix}jail-log\` **kullanmak için,** \`Yönetici\` **yetkisine sahip olman gerekiyor.**`)).then(a => a.delete({timeout: 10000}));
  ...
  db.set(`jail.log.${message.guild.id}`, mentionChannel.id);
